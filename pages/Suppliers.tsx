...
import { Plus, Edit2, Trash2, Search, Truck, Mail, Phone, Building, ShoppingCart, Archive, DollarSign, Calendar, X, Save, ArrowRight, Package, Check, AlertCircle, PackagePlus, History, Zap, Box, Tag, Receipt, List } from 'lucide-react';
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden animate-[fadeIn_0.3s_ease-out]">
                <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row gap-4 justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-xl font-medium shadow-lg shadow-indigo-200 dark:shadow-none transition-all active:scale-95"
                    >
                ...
                <div className="md:hidden divide-y divide-slate-100 dark:divide-slate-800">
                    {filteredSuppliers.map(supplier => (
                        <div key={supplier.id} className="p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50">
